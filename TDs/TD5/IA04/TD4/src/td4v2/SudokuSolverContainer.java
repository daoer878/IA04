...
public class SudokuSolverContainer {
	...
	public static void main(String[] args) {
		...
		try {
			...
			AgentController ac = cc.createNewAgent("Simulation", "td4v2.AgentSimulation", null);
			AgentController ac2 = cc.createNewAgent("Environnement", "td4v2.AgentEnvironnement", null);
			...
			for(int i = 0; i < 27; i++)
			{
				agentAnalyse.add(cc.createNewAgent("Analyse" + String.valueOf(i), "td4v2.AgentAnalyse", null));
			}
